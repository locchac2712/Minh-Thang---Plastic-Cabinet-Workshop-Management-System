-- Init Schema + Seed Data cho Docker PostgreSQL
...
-- M–N vật tư – NCC (khớp JPA + Flyway V5; bắt buộc khi Flyway tắt trong docker-compose)
...
-- =============================================
-- DEFAULT ADMIN (Docker init — không cần seed_data.sql để có user đầu tiên)
-- Plaintext: khớp NoOpPasswordEncoder trong backend; đổi mật khẩu ngay sau deploy.
-- =============================================
...
-- Seed dữ liệu demo (đại lý, đơn, …) vẫn là file tùy chọn: seed_data.sql
