...
const LS_KEY = 'tunhua-admin-sidebar-collapsed'
const HTML_CLASS = 'th-admin-sidebar-collapsed'
...
/**
 * Giống pattern SuDo: desktop rail + persist localStorage + class trên <html> để grid co giãn.
 */
