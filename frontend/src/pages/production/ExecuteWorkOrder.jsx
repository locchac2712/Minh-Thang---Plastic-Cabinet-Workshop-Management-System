                        ...
                        <div key={plan.id} className="sp-card" style={{ padding: 0, overflow: "hidden", border: expandedPlan === plan.id ? "2px solid #7c3aed" : "1.5px solid #e2e8f0" }}>
                            ...
                            >
                                ...
                                <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                                    ...
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" style={{ transform: expandedPlan === plan.id ? "rotate(180deg)" : "none", transition: "0.2s" }}>
                                        <path d="M6 9l6 6 6-6"/>
                                    </svg>
                                </div>
                            </div>
