        ...
        const loadCustomer = async () => {
            try {
                ...
                setForm({
                    ...
                    phoneDesktop: customer.phoneDesktop || "",
                ...
                setErrors({ general: "Không thể tải thông tin khách hàng" });
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="sq-modal-box sq-modal-box--large" onClick={e => e.stopPropagation()}>
                <div className="sq-modal-header">
                    <div className="sq-modal-title-group">
                        <h2 className="sq-modal-title">Cập nhật thông tin khách hàng</h2>
                        <span className="sq-modal-sub">Cập nhật thông tin chi tiết của đối tác doanh nghiệp</span>
                    </div>
