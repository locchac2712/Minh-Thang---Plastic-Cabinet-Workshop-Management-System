        ...
        <div style={{ padding: '24px 32px', background: '#fafbfc', minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 32 }}>
                <div style={{ display: 'flex', gap: 16 }}>
                    ...
                    <div>
                        <h1 style={{ fontSize: 26, fontWeight: 800, margin: '0 0 4px 0', color: '#0f172a' }}>Chỉnh sửa hồ sơ</h1>
                        <p style={{ margin: 0, fontSize: 13, color: '#94a3b8', fontWeight: 500 }}>{form.name || 'Đang tải...'} • {form.taxCode || 'CRM Partner'}</p>
                    </div>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    ...
                    <div style={cardStyle}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 24, marginTop: 24 }}>
                            <div className="af-field">
                                <label className="af-label">Trạng thái hoạt động</label>
                                <div style={{ display: 'flex', gap: 12, marginTop: 8 }}>
                                    <button 
                                        onClick={() => set("active", true)}
                                        style={{ flex: 1, padding: '10px', borderRadius: 10, border: `1px solid ${form.active ? '#10b981' : '#e2e8f0'}`, background: form.active ? '#ecfdf5' : '#fff', color: form.active ? '#059669' : '#64748b', fontWeight: 700, cursor: 'pointer', fontSize: 13 }}
                                    >Hoạt động</button>
                                    <button 
                                        onClick={() => set("active", false)}
                                        style={{ flex: 1, padding: '10px', borderRadius: 10, border: `1px solid ${!form.active ? '#ef4444' : '#e2e8f0'}`, background: !form.active ? '#fef2f2' : '#fff', color: !form.active ? '#dc2626' : '#64748b', fontWeight: 700, cursor: 'pointer', fontSize: 13 }}
                                    >Tạm ngưng</button>
                                </div>
                            </div>
                            <div className="af-field">
